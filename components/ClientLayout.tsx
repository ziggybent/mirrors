...
const LayoutContent: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  return (
    <>
      ...
      {/* Logo - fixed top-left */}
      <Link href="/" className="fixed top-20 left-[50px] z-50">
        <Display
          size="md"
      ...
      <div className="fixed bottom-20 left-[50px] z-50 flex gap-4">
        <a
          href="#"
          className={`transition-colors duration-300 ${
            theme === 'dark'
      ...
      <button
        className={`fixed top-20 right-[50px] z-50 rounded-full px-6 py-2 transition-colors duration-300 ${
          theme === 'dark'
